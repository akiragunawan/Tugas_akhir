        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">List Ujian Proposal</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href=<?php echo base_url() ?>>Home</a></li>
                                <li class="breadcrumb-item active">List Ujian Proposal</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                <table id="table_list_ujian_proposal" class="table table-bordered table-striped dataTable data" role="grid" aria-describedby="example1_info" style="width:100%">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th tabindex="0" rowspan="1" colspan="1" style="width: 29px;">Dosen pembimbing 2</th>
                                                            <th tabindex="0" rowspan="1" colspan="1" style="width: 29px;">Tanggal Ujian</th>
                                                            <th tabindex="0" rowspan="1" colspan="1" style="width: 29px;" hidden>Proposal Path</th>
                                                            <th tabindex="0" rowspan="1" colspan="1" style="width: 10px;">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="list_ujian_proposal">
